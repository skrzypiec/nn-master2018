...
%
$$
\frac{d\sigma}{d\Omega}\left(\theta\right) = \left(\frac{1}{8 \pi \epsilon_0  E_{\alpha}} \right)^2 \frac{1}{4\sin^4 \frac{\theta}{2}}.
$$
%
...
%
$$
\hat{H} = \frac{\hat{p}^2}{2\mu} - \frac{e^2}{4\pi\varepsilon_0},
$$
%
przy wykorzystujaniu przybliżenia Borna, czyli jednej z metod przybliżonego rozwiązywania równania na stacjonarne stany rozproszeniowe, otrzymujemy wzór Rutherforda na różniczkowy przekrój czynny na rozpraszanie w potencjale kulombowskim $-\frac{\alpha}{r}$:
%
$$
\frac{d\sigma}{d\Omega}\left(\theta\right) = \frac{\alpha^2}{4k^4 \sin^4 \frac{\theta}{2}}.
$$
%
...
%Jakie rozpraszanie opisuje itp, dlaczego akurat takie jakie to przyniesie wyniki?
%\subsubsection{I}
%
\begin{figure}[htp!]
	\centering
