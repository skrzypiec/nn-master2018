...
\begin{figure}[htp!]
	\centering
	\includegraphics[width=1.1\textwidth]{hyperparameter14_16a.png}
...
\begin{figure}[hp!]
	\centering
	\includegraphics[width=1.2\textwidth]{ratio_2.eps}
...
\begin{table}
	...
	\begin{tabular}{c|c c c}
		...
		Algorytm uczący& $\alpha$ (\textit{learning rate}) & 0,02 & \\ \hline
