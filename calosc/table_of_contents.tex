...
\renewcommand{\maketitle}{\begin{titlepage}
		...
		\begin{center}		
			\huge \textsc{\@ Badanie elektromagnetycznych funkcji postaci protonu przy wykorzystaniu sztucznych sieci neuronowych}
			
			\vspace{0.5cm}
			
			\normalsize \textsc {Electromagnetic Form Factors of The Proton Studied with Neural Networks}
...
Konstrukcja takiej struktury sieci neuronowej w Kerasie jest nietrywialna, aby uzyskać opisany powyżej efekt skorzystano z warstw Lambda, które umożliwiają wykonywanie operacji arytmetycznych przez neurony w warstwach ukrytych w obrębie zdefiniowanej funkcji lambda. W tej konstrukcji każdy z neuronów wybranej warstwy ukrytej jest zdefiniowany jako warstwa Lambda. Operacje wykonywane na tensorach w obrębie funkcji lambda pozwalają wybrać, które neurony z warstwy poprzedzającej są wejściem. Następnie wszystkie wybrane neurony łączone są w jedną warstwę - warstwę ukrytą, w której neurony mają zdefiniowane przez nas wejścia. Kolejne warstwy tworzone są w analogiczny sposób. Tabela \ref{tab:hyper3} przedstawia wykorzystane hiperparametry sieci neuronowej. 
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.95\textwidth]{c2_eps_q2const_1.eps}
...
\begin{figure}
	...
	\begin{subfigure}[b]{1.\textwidth}
		\includegraphics[width=1.\linewidth]{d2_1.eps}
...
\begin{figure}
	...
	\begin{subfigure}[b]{1.\textwidth}
		\includegraphics[width=1.\linewidth]{d2_2.eps}
